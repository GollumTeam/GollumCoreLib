...
public class GCLGuiContainer extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		this.fontRenderer.drawString(I18n.format(this.inventoryBlock.getDisplayName().getUnformattedText()) , 8 + posX , top-13                                   , 0x404040);
		this.fontRenderer.drawString(I18n.format(this.inventoryPlayer.getDisplayName().getUnformattedText()), 8        , top+this.numRows*GCLContainer.SIZE_ITEM+6, 0x404040);
