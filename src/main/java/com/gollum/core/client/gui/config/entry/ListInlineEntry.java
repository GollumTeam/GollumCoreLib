...
public class ListInlineEntry extends ConfigEntry {
	...
	public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected, boolean resetControlWidth, float partial) {
		...
		this.btnLabel.x = this.parent.controlX + 20;
		this.btnLabel.y = y;
		this.btnLabel.width = this.parent.controlWidth - 40;
		this.btnLabel.drawButton(this.mc, mouseX, mouseY, partial);
		
		this.btnNext.x = this.parent.controlX + this.parent.controlWidth - 17;
		this.btnNext.y = y;
