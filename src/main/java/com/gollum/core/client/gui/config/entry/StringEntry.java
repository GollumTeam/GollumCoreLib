...
public class StringEntry extends ConfigEntry {
	...
	public StringEntry(int index, Minecraft mc, GuiConfigEntries parent, ConfigElement configElement) {
		...
		this.textFieldValue = new GuiTextField(0, this.mc.fontRenderer, this.parent.controlX + 1, 0, this.parent.controlWidth - 3, 16);
	...
	public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected, boolean resetControlWidth, float partial) {
		...
		this.textFieldValue.x = this.parent.controlX + 2;
