	...
	protected void applyExtra(
		...
		if (te instanceof TileEntitySign) {
			...
			try {
				...
				((TileEntitySign) te).signText[0] = new TextComponentString(text1);
				((TileEntitySign) te).signText[1] = new TextComponentString(text2);
				((TileEntitySign) te).signText[2] = new TextComponentString(text3);
				((TileEntitySign) te).signText[3] = new TextComponentString(text4);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
