...
public class ConfigGollumCoreLib extends Config {
	...
	@ConfigProp(group = "Items Ids") public int itemBuildingID = 15600;
	@ConfigProp(group = "Items Ids") public int itemWrenchID   = 15601;
	@ConfigProp(group = "Items Ids") public int itemInfosID    = 15602;
