...
public class MobSwpanConfigType extends ConfigJsonType {
	...
	public MobSwpanConfigType () {
	}
	
	public MobSwpanConfigType (double moveSpeed, double maxHealt, double attackStrength, double followRange) {
		this (moveSpeed, maxHealt, attackStrength, followRange, 0.D);
	}

	public MobSwpanConfigType (double moveSpeed, double maxHealt, double attackStrength, double followRange, double timeRange) {
