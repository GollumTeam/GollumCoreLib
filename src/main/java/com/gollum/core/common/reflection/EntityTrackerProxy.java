...
public class EntityTrackerProxy extends EntityTracker {
	...
	public void sendPacketToAllPlayersTrackingEntity(Entity par1Entity, Packet par2Packet) {
		synchronized (lock) {
			entityTracker.sendPacketToAllPlayersTrackingEntity(par1Entity, par2Packet);
		}
	}
	
	@Override
	public void sendPacketToAllAssociatedPlayers(Entity p_151248_1_, Packet p_151248_2_) {
		synchronized (lock) {
			entityTracker.sendPacketToAllAssociatedPlayers(p_151248_1_, p_151248_2_);
		}
	}
