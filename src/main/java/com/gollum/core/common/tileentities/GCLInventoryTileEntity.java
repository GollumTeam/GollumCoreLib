...
//			number = Math.min (number, this.inventory[slot].getCount());
...
//		if (!player.isSpectator() &&  this.getBlockType() == this.world.getBlockState(pos).getBlock()) {
//			--this.numUsingPlayers;
//			this.world.addBlockEvent(this.pos, this.getBlockType(), 1, this.numUsingPlayers);
...
//			x, y, z, 
//			RegisteredObjects.instance().getSoundEvent(this.soundClosedInventory),
//			RegisteredObjects.instance().getSoundCategoryBySound(this.soundClosedInventory), 
//			this.volumeSoundOpenClosedInventory,
...
//		this.world.playSound(
//			x, y, z, 
//			RegisteredObjects.instance().getSoundEvent(this.volumeSoundOpenClosedInventory),
//			RegisteredObjects.instance().getSoundCategoryBySound(this.volumeSoundOpenClosedInventory), 
//			this.volumeSoundOpenClosedInventory,
//			this.world.rand.nextFloat() * 0.1F + 0.9F,
//			false
//		);
