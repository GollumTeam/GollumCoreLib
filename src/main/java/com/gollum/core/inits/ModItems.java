...
public class ModItems {
	...
	public static void init() {
		ModItems.itemBuilding = new ItemBuilding(ModGollumCoreLib.config.itemBuildingID, "Building");
		ModItems.itemWrench   = new ItemWrench  (ModGollumCoreLib.config.itemWrenchID, "Wrench");
		ModItems.itemInfos    = new ItemInfos   (ModGollumCoreLib.config.itemInfosID, "Infos");
