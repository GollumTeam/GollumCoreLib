...
import mods.gollum.core.client.gui.config.element.EmptyArrayElement;
...
import cpw.mods.fml.client.config.GuiEditArrayEntries.BaseEntry;
...
public class GuiEditArrayEntriesProxy extends GuiEditArrayEntries {
	
	public GuiEditArrayEntriesProxy(GuiEditArrayCustomEntries entryList) {
		super(entryList.parent, entryList.mc, new EmptyArrayElement(), entryList.beforeValues, entryList.currentValues);
	}
